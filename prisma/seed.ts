...
const LOCATION_MAP: Record<string, string> = {
  ...
  "Skeletal Muscle (L.S. striated)": "Attached to skeleton",
  "Cardiac Muscle (L.S. from wall of the heart)": "Heart wall (myocardium)",
  "Smooth Muscle (L.S. unstriated) from wall of urinary bladder": "Walls of hollow visceral organs",
  "T.S. of Pancreas of Rat": "Retroperitoneal, behind stomach",
  "T.S. of Ileum of Rabbit": "Abdomen (terminal small intestine)",
  "T.S. of Kidney of Rabbit": "Retroperitoneal, posterior abdominal wall",
  "T.S. of Esophagus of Rabbit": "Mediastinum, connecting pharynx to stomach",
  "V.S. of Skin of Pig": "External surface of entire body",
  "T.S. of Testis of Rat": "Scrotal sac",
  "T.S. of Liver of Pig": "Right upper quadrant of abdomen",
  "T.S. of Trachea of Rabbit": "Anterior neck & superior mediastinum",
  "T.S. of Stomach of Rabbit": "Left upper quadrant of abdomen",
...
const CLINICAL_MAP: Record<string, string> = {
  ...
  "Skeletal Muscle (L.S. striated)": "A muscle biopsy shows long, multinucleated fibers with peripheral nuclei and visible striations. What muscle type is this?",
  "Cardiac Muscle (L.S. from wall of the heart)": "A heart biopsy shows branching fibers with central nuclei and dark intercalated discs. What tissue is this?",
  "Smooth Muscle (L.S. unstriated) from wall of urinary bladder": "A stomach biopsy shows spindle-shaped cells with central oval nuclei and no striations. What muscle type is this?",
  ...
  "T.S. of Pancreas of Rat": "A biopsy from a diabetic patient shows pale cell clusters (islets) surrounded by darker acinar cells. What organ is this?",
  "T.S. of Ileum of Rabbit": "A bowel biopsy shows finger-like villi projecting into the lumen, lined by columnar cells with many goblet cells. What part of the GI tract is this?",
  "T.S. of Kidney of Rabbit": "A renal biopsy shows cortical tissue with spherical glomeruli enclosed in Bowman's capsule. What organ is this?",
  "T.S. of Liver of Pig": "A biopsy shows hepatocytes arranged in cords radiating from a central vein forming hexagonal lobules. What organ is this?",
  "T.S. of Trachea of Rabbit": "A windpipe biopsy shows pseudostratified ciliated columnar epithelium overlying C-shaped rings of hyaline cartilage. What structure is this?",
  "T.S. of Stomach of Rabbit": "A biopsy shows deep gastric pits with NO goblet cells. The lamina propria contains gastric glands. What organ is this?",
  "V.S. of Skin of Pig": "A palm biopsy shows a very thick keratinized epithelium with hair follicles and sebaceous glands below. What is this specimen?",
  "T.S. of Esophagus of Rabbit": "A dysphagia patient biopsy shows very thick non-keratinized stratified squamous epithelium with a prominent folded mucosa. What organ is this?",
